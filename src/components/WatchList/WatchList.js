...
import { useGetWatchlistQuery } from "redux/movies/moviesApi";
import { selectSessionId } from "redux/selectors";
import { imgUrl } from "services/apiConst";
import { Wrapper } from "./WatchList.styled";
...
const WatchList = () => {
  ...
  const { data, isLoading, isError, refetch } = useGetWatchlistQuery(fetchData);
